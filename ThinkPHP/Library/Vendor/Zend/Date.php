...
class Zend_Date extends Zend_Date_DateObject {
	...
	public function toString($format = null, $type = null, $locale = null) {
		...
		if (($format !== null) and ! defined ( $format ) and ($format != 'ee') and ($format != 'ss') and Zend_Locale::isLocale ( $format, null, false )) {
			$locale = $format;
			$format = null;
		}
	 ...
	 * @param $calc string
	 *        	Type of calculation to make
	 * @param $day string|integer|Zend_Date
	 ...
	 * @param $calc string
	 *        	Type of calculation to make
	 * @param $weekday string|integer|array|Zend_Date
