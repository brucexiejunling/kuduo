...
class PHPMailer {
	...
	/**
	 * Sets SMTP auth type.
	 * Options are LOGIN | PLAIN | NTLM | CRAM-MD5 (default LOGIN)
	 * 
	 * @var string
	 */
	public $AuthType = '';
